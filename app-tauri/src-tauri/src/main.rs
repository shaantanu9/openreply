...
fn main() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::style_rules_get,
            commands::style_rules_set,
            ...
            commands::gap_pain_scores,
            commands::gap_pain_scores_build,
            commands::gap_audience,
            commands::gap_audience_build,
            commands::gap_velocity,
            commands::topic_velocity,
            commands::gap_alerts_list,
            commands::gap_alert_create,
            commands::gap_alert_delete,
            commands::gap_alerts_check,
            commands::gap_alert_events,
            commands::gap_verdict,
            commands::gap_digest,
            commands::import_gummysearch,
            commands::audiences_list,
            commands::audience_presets,
            commands::audience_add_preset,
            ...
            commands::fleet_command,
            commands::academic_brief_run,
            commands::academic_brief_run_stream,
            commands::academic_brief_get,
            commands::academic_passport_get,
            commands::market_get,
            commands::market_compute,
            commands::porter_forces_get,
            commands::porter_forces_compute,
            commands::swot_get,
            commands::swot_compute,
            commands::lean_canvas_get,
            commands::lean_canvas_compute,
            commands::value_prop_get,
            commands::value_prop_compute,
            commands::north_star_get,
            commands::north_star_compute,
            ...
            commands::research_conclusions_get,
            commands::research_conclusions_compute,
