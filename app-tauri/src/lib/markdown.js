// Minimal, XSS-safe markdown renderer shared by the chat panel (topic tab +
// global Chats sidebar) and other markdown surfaces. Extracted from topic.js so
// the reusable chatPanel doesn't have to drag the whole topic screen in.
