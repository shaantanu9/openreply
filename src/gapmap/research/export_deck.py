...
def render_planned_docx(plan: dict, out_path: str) -> dict[str, Any]:
    ...
    if not _DOCX_OK:
        return {
            ...
            "install_hint": "pip install 'gapmap[docs]'",
        }
    from . import _doc_design as ds
...
def build_pptx(
    ...
    if not _PPTX_OK:
        return {
            ...
            "install_hint": "pip install 'gapmap[docs]'  # or:  pip install python-pptx",
        }
...
def build_pdf_from_markdown(
    ...
    if not _PANDOC_OK:
        return {
            ...
            "install_hint": "pip install 'gapmap[docs]'  # bundles pandoc binary",
        }
