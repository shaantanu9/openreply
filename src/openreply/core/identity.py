...
PROJECT_NAME = "openreply"
GITHUB_ORG = "myind-ai"
GITHUB_REPO = "openreply"
GITHUB_URL = f"https://github.com/{GITHUB_ORG}/{GITHUB_REPO}"
DOCS_METHODOLOGY_URL = f"{GITHUB_URL}/blob/main/docs/methodology.md"
HOMEPAGE_URL = "https://openreply.myind.ai"

# Polite-API contact surfaced in the User-Agent `mailto:` (OpenAlex/arXiv/PubMed
# use it to reach the maintainer). Override per-deployment with OPENREPLY_CONTACT.
CONTACT_EMAIL = os.getenv("OPENREPLY_CONTACT", "shantanubombatkar2@gmail.com")
