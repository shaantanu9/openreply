...
keep the `openreply_persona_*` naming convention consistent with the rest
of the surface.
"""
...
def openreply_persona_create(
    ...
    `persona_memories`. Use `openreply_persona_ingest` to run it over
    collected posts.
...
@persona_server.tool()
def openreply_persona_list(active_only: bool = False) -> list[dict]:
...
@persona_server.tool()
def openreply_persona_get(persona_id: int) -> dict | None:
...
@persona_server.tool()
def openreply_persona_delete(persona_id: int) -> dict:
...
@persona_server.tool()
def openreply_persona_memories(
    persona_id: int,
    topic: str | None = None,
    limit: int = 50,
    offset: int = 0,
...
def openreply_persona_ingest(
    ...
    Use `openreply_persona_memories` to read the resulting lessons.
    """
...
@persona_server.tool()
def openreply_persona_conclusions_build(
    persona_id: int,
    provider: str | None = None,
    refresh: bool = True,
) -> dict:
    ...
    Use `openreply_persona_conclusions_get` for cached reads.
    """
...
@persona_server.tool()
def openreply_persona_conclusions_get(
    persona_id: int,
    limit: int = 50,
) -> list[dict]:
    ...
    Call `openreply_persona_conclusions_build` first if the list is empty.
    """
...
def openreply_persona_graph(
    ...
    Run `openreply_persona_graph_backfill` first if the graph looks sparse.
    """
...
@persona_server.tool()
def openreply_persona_graph_backfill(persona_id: int) -> dict:
...
@persona_server.tool()
def openreply_persona_teach_youtube(
    persona_id: int,
    url_or_id: str,
...
@persona_server.tool()
def openreply_persona_ingest_peers(
    persona_id: int,
    limit: int = 50,
    provider: str | None = None,
) -> dict:
...
@persona_server.tool()
def openreply_persona_rejections(
    persona_id: int,
...
@persona_server.tool()
def openreply_agent_link_persona(
    agent_id: str,
    persona_id: int,
    weight: float = 1.0,
) -> dict:
...
@persona_server.tool()
def openreply_agent_unlink_persona(agent_id: str, persona_id: int) -> dict:
...
@persona_server.tool()
def openreply_agent_personas(agent_id: str) -> dict:
