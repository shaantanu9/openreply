...
### Paper writing pipeline (`src/openreply/research/paper_pipeline.py`)
...
- `src/openreply/research/paper_pipeline.py` — LLM draft + template fallback, real references, docx/pdf export.
- `src/openreply/mcp/server.py` — chunk+embed step in the research pipeline.
