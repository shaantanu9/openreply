...
- **Splashscreen** — new `splash.html` (cream + orange Gap Map branding matching the app); main window starts hidden and is revealed by a new `close_splash` Rust command after the first route renders.
