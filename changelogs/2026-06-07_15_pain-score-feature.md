...
- CLI: `gapmap research gap-pain-scores --topic … [--build] [--limit] [--force] [--csv]`.
- MCP: `gapmap_gap_pain_scores(topic, build, limit, force)` tool.
...
- `src/gapmap/research/pain_scoring.py`
- `app-tauri/src/screens/pain_scores.js`
- `tests/test_pain_scoring.py`

## Files Modified

- `src/gapmap/cli/main.py` — `gap-pain-scores` command.
- `src/gapmap/mcp/server.py` — `gapmap_gap_pain_scores` tool.
