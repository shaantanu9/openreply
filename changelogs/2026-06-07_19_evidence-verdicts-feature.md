...
- CLI: `gapmap research gap-verdict --topic … [--claim] [--limit]`.
- MCP: `gapmap_gap_verdict(topic, claim, limit)` tool.
...
- `src/gapmap/research/evidence_verdicts.py`
