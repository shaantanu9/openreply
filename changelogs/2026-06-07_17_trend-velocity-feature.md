...
- CLI: `gapmap research gap-velocity --topic … [--gap-id] [--window] [--topic-level]`.
- MCP: `gapmap_gap_velocity(topic, gap_id, window_days, topic_level)` tool.
...
- `src/gapmap/research/trend_velocity.py`
