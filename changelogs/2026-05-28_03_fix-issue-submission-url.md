# Fix issue/help URLs to point at canonical myind-ai/gapmap repo
...
- Issue submission button (settings.js:506) → `https://github.com/myind-ai/gapmap/issues`
- Settings "Open README" button (settings.js:1097) → `https://github.com/myind-ai/gapmap`
- Settings "Auth docs" button (settings.js:1208) → `https://github.com/myind-ai/gapmap#readme`
- Onboarding Reddit setup-guide button (welcome.js:470) → `https://github.com/myind-ai/gapmap#readme`
- Sidebar Help & docs link (index.html:151) → `https://github.com/myind-ai/gapmap`
