...
- CLI: `gapmap research gap-alerts --action list|create|update|delete|check|events …`.
- MCP: `gapmap_gap_alerts(action, topic, alert_type, gap_id, threshold, …)` tool.
...
- `src/gapmap/research/gap_alerts.py`
